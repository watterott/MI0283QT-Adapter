...
typedef struct
{
  ...
  __I  uint32_t SYSRSTSTAT;             /*!< Offset: 0x030 System reset status Register (R/ ) */
...
typedef struct
{
  ...
  __IO uint32_t R_PIO0_10;              /*!< Offset: 0x068 I/O configuration for pin SWCLK/PIO0_10/SCK0/CT16B0_MAT2 (R/W) */
  ...
  __IO uint32_t R_PIO1_3;               /*!< Offset: 0x090 I/O configuration for pin SWDIO/PIO1_3/AD4/CT32B1_MAT2 (R/W) */
